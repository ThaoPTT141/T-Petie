      ...
      <div className="bg-white rounded-3xl border border-cream-200 shadow-card overflow-hidden p-6 sm:p-10 flex flex-col justify-center min-h-[580px]">
          <div className="w-full space-y-6">
            ...
            <button
              ...
              className="w-full py-3 px-4 rounded-2xl border border-cream-300 hover:border-honey-300 bg-cream-50/50 hover:bg-cream-50 text-charcoal-800 text-xs sm:text-sm font-semibold flex items-center justify-center space-x-3 transition-all active:scale-95 shadow-2xs"
            >
              {/* Google SVG Icon */}
